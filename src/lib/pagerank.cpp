    ...
    if (my_ip != "192.168.0.102"){
        ...
        for(int i =0; i<num_vertex;i++){
            ...
            if(cmd == "1")
                ...
                double after_avg = 16;//78;//396;//46;//146;//69;//59;//88;//127;//260;//812;//188;//403;//146;//127;//68;//31;//9;  (403: twiter 0.9) (188: twitter 0.8) (812: twitter 0.95) (260: twitter 0.85) (127: lj 0.95) (88: lj 0.9)(69: lj 0.85)(59: lj 0.8)(146: wt 0.9)
