    ...
    if (my_ip != "1235"){
        ...
        for(int i =0; i<num_vertex;i++){
            ...
            if(cmd == "1")
                ...
                weight = pow(num_outgoing[i],1/1.7);
            else if(cmd == "4")
                weight = pow(num_outgoing[i]+3.0,1/1.3);//sqrt(num_outgoing[i]+6.0);
            else if(cmd == "5")
                weight = pow(num_outgoing[i]+2.0,1/1.33);
            else{
                avg = 2;//15.9151;//6.54044;//5.57058;//11.092;//35.253;//14.2362;//35.253;//35.253;//2;//35.253;//14.2362;//14.2362;//2;//14.2362;//14.2362;//35.253;//+36;
                std = 99.915;//30.4273;//6.55653;//16.356;//2419.74;//36.0803;//2419.74;//2419.74;//99.915;//36.0803;//36.0803;//2419.74;
                max = 20293;
