    ...
    if (my_ip != "192.168.0.102"){
        ...
        for(int i =0; i<num_vertex;i++){
            ...
            if(cmd == "1")
                ...
                weight = 1 + (sqrt(num_outgoing[i]+(z_score)*unit_step_func(z_score-round(avg)))-1)*unit_step_func(z_score);
            }
            else{
                avg =35.253;//35.253;//14.2326;//15.9151;//27.528;//14.2326;//35.253;//35.253;//14.2326;//14.2326;//14.2326;//14.2362;//35.253;// 27.528;//35.253;//14.2362;//35.253;//14.2362;//15.9151;//2;//15.9151;//6.54044;//5.57058;//11.092;//35.253;//14.2362;//35.253;//35.253;//2;//35.253;//14.2362;//14.2362;//2;//14.2362;//14.2362;//35.253;//+36;
                ...
                double after_avg = 403;//127;//78;//396;//46;//146;//69;//59;//88;//127;//260;//812;//188;//403;//146;//127;//68;//31;//9;  (403: twiter 0.9) (188: twitter 0.8) (812: twitter 0.95) (260: twitter 0.85) (127: lj 0.95) (88: lj 0.9)(69: lj 0.85)(59: lj 0.8)(146: wt 0.9)
